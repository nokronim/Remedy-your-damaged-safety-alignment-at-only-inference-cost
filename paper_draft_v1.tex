...
\caption{Main results across three holdout splits (4 unseen domains each). \textbf{Harm.\ Rate}: \% of BeaverTails prompts producing harmful output (beaver-dam-7b; lower is safer). LoRA degrades safety to up to 43\%; \method{} restores it to $<$0.5\% with $<$1\% accuracy drop. $^\dagger$20\% holdout eval; others use official HF splits.}
...
% Figures: see figures/FIGURE_SPEC.md for specifications
