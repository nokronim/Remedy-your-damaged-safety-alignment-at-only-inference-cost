...
\midrule
\multirow{4}{*}{A}
& BoolQ       & 65.8 & 92.2 & 92.1 \drop{-0.1} & 99.9 & 100 & 100  & 81.9 & 92.9 & 92.8 \drop{-0.1} & 99.4 & 100 & 98.0 \\
& AG News     & 77.6 & 90.6 & 90.6 \same        & 99.7 & 100 & 99.7 & 72.1 & 98.7 & 98.7 \same        & 99.7 & 100 & 98.0 \\
& SocialIQA   & 77.8 & 97.0 & 96.8 \drop{-0.2}  & 99.4 & 100 & 99.3 & 70.2 & 92.5 & 92.3 \drop{-0.2}  & 99.1 & 100 & 97.3 \\
& Comp.\ Math & 32.4 & 34.1 & 34.1 \same         & 99.6 & 100 & 99.7 & 42.2 & 74.4 & 74.4 \same        & 99.3 & 100 & 98.7 \\
\midrule
\multirow{4}{*}{B}
& CSenseQA    & 70.8 & 97.1 & 96.8 \drop{-0.3}  & 99.4 & 100 & 99.7 & 72.7 & 94.0 & 93.8 \drop{-0.2}  & 99.1 & 100 & 97.3 \\
& PIQA        & 60.4 & 97.5 & 97.2 \drop{-0.3}  & 99.7 & 100 & 100  & 56.7 & 99.1 & 99.0 \drop{-0.1}  & 99.4 & 100 & 98.3 \\
& GSM8K       & 76.9 & 67.3 & 67.3 \same         & 99.0 & 100 & 99.3 & 79.0 & 76.2 & 76.2 \same        & 98.9 & 100 & 97.7 \\
& Alpaca      & 24.8 & 39.0 & 38.8 \drop{-0.2}  & 99.3 & 100 & 99.3 & 29.5 & 39.6 & 39.5 \drop{-0.1}  & 99.1 & 100 & 97.7 \\
\midrule
\multirow{4}{*}{C}
& NQ-Open     & 35.6 & 77.5 & 77.0 \drop{-0.5}  & 98.7 & 100 & 99.0 & 30.3 & 54.8 & 54.6 \drop{-0.2}  & 99.1 & 100 & 97.3 \\
& ARC         & 87.7 & 86.5 & 86.5 \same          & 99.3 & 100 & 99.7 & 89.2 & 91.3 & 91.3 \same        & 99.0 & 100 & 98.0 \\
& HellaSwag   & 50.9 & 92.2 & 91.5 \drop{-0.7}  & 99.7 & 100 & 100  & 67.0 & 97.8 & 97.4 \drop{-0.4}  & 98.6 & 100 & 97.7 \\
& OpenHermes  & 24.8 & 54.8 & 54.5 \drop{-0.3}  & 99.4 & 100 & 99.7 & 35.9 & 57.2 & 57.0 \drop{-0.2}  & 99.0 & 100 & 97.3 \\
\midrule
\multicolumn{2}{@{}l}{\textbf{Average}} & --- & --- & --- \drop{-0.2} & 99.4 & 100 & 99.6 & --- & --- & --- \drop{-0.1} & 99.1 & 100 & 97.8 \\
\bottomrule
\end{tabular}%
}
\caption{Main results across three holdout splits on unseen domains. \textbf{Task Acc}: domain-specific accuracy; deltas relative to LoRA shown in {\color{green!60!black}green} (preserved) or {\color{red!70!black}red} (minor drop). \textbf{Safety}: harmful prompt detection rate (\% of harmful prompts where $\lambda > 0.5$, triggering refusal) on BeaverTails (BT, 700 prompts), AdvBench (Adv, 520 prompts), and HEx-PHI (HEx, 300 prompts). Only BT is seen during training; Adv and HEx test zero-shot transfer. Each split holds out 4 of 22 domains; the hypernetwork trains on the remaining 18.}
