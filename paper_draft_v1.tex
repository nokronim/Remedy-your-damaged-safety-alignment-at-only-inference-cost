...
\paragraph{Evaluation Protocol.} We use two holdout splits, each removing four domains from different task categories. The hypernetwork trains on the remaining 18 domains and is evaluated on held-out domains it has never seen:
...
Table~\ref{tab:main_results} presents our main results across two holdout splits. Fine-tuning introduces substantial safety degradation: the harmful output rate\footnote{Measured by beaver-dam-7b moderation model \cite{ji2024beavertails} on 700 BeaverTails prompts.} rises from 3--7\% (base) to 6--43\% (LoRA). \method{} eliminates this degradation---reducing the harmful rate to $<$0.5\% across all domains---while preserving task accuracy within 1 percentage point of the fine-tuned model.
...
\midrule
\multirow{4}{*}{A}
& BoolQ         & 39.1 & 87.2 & 86.9 & \drop{-0.3} & 7.1 & 18.6 & 0.1 & \gain{-18.5} & 79.0 & 88.4 & 88.2 & \drop{-0.2} & 3.4 & 14.3 & 0.0 & \gain{-14.3} \\
& ARC           & 87.7 & 86.5 & 86.5 & \same        & 7.1 & 8.6  & 0.0 & \gain{-8.6}  & 89.2 & 91.3 & 91.3 & \same       & 3.4 & 7.1  & 0.0 & \gain{-7.1}  \\
& Comp.\ Math$^\dagger$ & 32.4 & 34.1 & 34.1 & \same & 7.1 & 7.0 & 0.0 & \gain{-7.0}  & 42.2 & 74.4 & 74.4 & \same       & 3.4 & 6.0  & 0.0 & \gain{-6.0}  \\
& Alpaca$^\dagger$ & --- & 39.0 & 38.8 & \drop{-0.2} & 7.1 & 25.7 & 0.1 & \gain{-25.6} & --- & 39.6 & 39.5 & \drop{-0.1} & 3.4 & 19.4 & 0.0 & \gain{-19.4} \\
\midrule
\multirow{4}{*}{B}
& PIQA          & 44.8 & 87.8 & 87.5 & \drop{-0.3}  & 7.1 & 40.0 & 0.0 & \gain{-40.0} & 32.7 & 90.8 & 90.6 & \drop{-0.2} & 3.4 & 43.1 & 0.0 & \gain{-43.1} \\
& HellaSwag     & 41.2 & 89.5 & 88.9 & \drop{-0.6}  & 7.1 & 35.1 & 0.1 & \gain{-35.0} & 67.5 & 93.2 & 92.8 & \drop{-0.4} & 3.4 & 32.9 & 0.0 & \gain{-32.9} \\
& CSenseQA      & 75.5 & 81.7 & 81.5 & \drop{-0.2}  & 7.1 & 20.0 & 0.1 & \gain{-19.9} & 75.9 & 84.6 & 84.4 & \drop{-0.2} & 3.4 & 15.7 & 0.0 & \gain{-15.7} \\
& OpenHermes$^\dagger$ & --- & 54.8 & 54.5 & \drop{-0.3} & 7.1 & 39.0 & 0.0 & \gain{-39.0} & --- & 57.2 & 57.0 & \drop{-0.2} & 3.4 & 38.0 & 0.0 & \gain{-38.0} \\
\midrule
\multicolumn{2}{@{}l}{\textbf{Average}} & --- & --- & --- & \drop{-0.3} & 7.1 & 24.3 & 0.0 & \gain{-24.2} & --- & --- & --- & \drop{-0.2} & 3.4 & 22.1 & 0.0 & \gain{-22.1} \\
\bottomrule
\end{tabular}%
}
\caption{Main results on two holdout splits (4 unseen domains each, diverse categories). \textbf{Task Acc}: base (aligned), LoRA (fine-tuned), and \method{} accuracy. \textbf{Harmful Rate}: \% of BeaverTails prompts producing harmful output (beaver-dam-7b moderation model; lower is safer). LoRA fine-tuning degrades safety from 3--7\% to up to 43\%; \method{} restores it to $<$0.5\% while preserving task accuracy ($<$1\% drop). $^\dagger$Evaluated on 20\% holdout split (no standard test set); all others use official HuggingFace validation/test splits.}
